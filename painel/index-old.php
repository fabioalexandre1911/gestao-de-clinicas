...
<body class="cbp-spmenu-push">
	<div class="main-content">
			...
			<aside class="sidebar-left">
				<nav class="navbar navbar-inverse" style="overflow: scroll; height:100%; scrollbar-width: thin;">
					<div class="navbar-header">
						...
						<h1><a class="navbar-brand" href="?"><span class="fa fa-area-chart"></span> Sistema<span class="dashboard_text"><?php echo $nome_sistema ?></span></a></h1>
					</div>
						...
						<ul class="sidebar-menu">
							...
							<li class="treeview ">
								...
								<ul class="treeview-menu">
									<li class=""><a href="index.php?pag=usuarios"><i class="fa fa-angle-right"></i>Usuários</a></li>
									<li class=""><a href="index.php?pag=funcionarios"><i class="fa fa-angle-right"></i>Funcionários</a></li>
									<li class=""><a href="index.php?pag=clientes"><i class="fa fa-angle-right"></i>Clientes</a></li>

									<li class=""><a href="index.php?pag=clientes_retorno"><i class="fa fa-angle-right"></i>Clientes Retornos</a></li>

									<li class=""><a href="index.php?pag=fornecedores"><i class="fa fa-angle-right"></i>Fornecedores</a></li>
							...
							<li class="treeview " >
								...
								<ul class="treeview-menu">
									<li class=""><a href="index.php?pag=servicos"><i class="fa fa-angle-right"></i>Serviços</a></li>

									<li class=""><a href="index.php?pag=cargos"><i class="fa fa-angle-right"></i>Cargos</a></li>

									<li class=""><a href="index.php?pag=cat_servicos"><i class="fa fa-angle-right"></i>Categoria Serviços</a></li>

									<li class=""><a href="index.php?pag=grupos"><i class="fa fa-angle-right"></i>Grupo Acessos</a></li>

									<li class=""><a href="index.php?pag=acessos"><i class="fa fa-angle-right"></i>Acessos</a></li>
							...
							<li class="treeview ">
								...
								<ul class="treeview-menu">
									...
									<li class=""><a href="index.php?pag=produtos"><i class="fa fa-angle-right"></i>Produtos</a></li>

									<li class=""><a href="index.php?pag=cat_produtos"><i class="fa fa-angle-right"></i>Categorias</a></li>
									
									<li class=""><a href="index.php?pag=estoque"><i class="fa fa-angle-right"></i>Estoque Baixo</a></li>

									<li class=""><a href="index.php?pag=saidas"><i class="fa fa-angle-right"></i>Saídas</a></li>

									<li class=""><a href="index.php?pag=entradas"><i class="fa fa-angle-right"></i>Entradas</a></li>
							...
							<li class="treeview " >
								...
								<ul class="treeview-menu">
									...
									<li class=""><a href="index.php?pag=vendas"><i class="fa fa-angle-right"></i>Vendas</a></li>

									<li class=""><a href="index.php?pag=compras"><i class="fa fa-angle-right"></i>Compras</a></li>
									
									<li class=""><a href="index.php?pag=pagar"><i class="fa fa-angle-right"></i>Contas à Pagar</a></li>

									<li class=""><a href="index.php?pag=receber"><i class="fa fa-angle-right"></i>Contas à Receber</a></li>	

									<li class=""><a href="index.php?pag=comissoes"><i class="fa fa-angle-right"></i>Comissões</a></li>									
							...
							<li class="treeview ">
								...
								<ul class="treeview-menu">
									...
									<li class=""><a href="index.php?pag=agendamentos"><i class="fa fa-angle-right"></i>Agendamentos</a></li>

									<li class=""><a href="index.php?pag=servicos_agenda"><i class="fa fa-angle-right"></i>Serviços</a></li>
							...
							<li class="treeview " >
								...
								<ul class="treeview-menu">
									...
									<li class=""><a href="rel/rel_produtos_class.php" target="_blank"><i class="fa fa-angle-right"></i>Relatório de Produtos</a></li>

									<li class=""><a href="#" data-toggle="modal" data-target="#RelEntradas"><i class="fa fa-angle-right"></i>Entradas / Ganhos</a></li>

									<li class=""><a href="#" data-toggle="modal" data-target="#RelSaidas"><i class="fa fa-angle-right"></i>Saídas / Despesas</a></li>

									<li class=""><a href="#" data-toggle="modal" data-target="#RelComissoes"><i class="fa fa-angle-right"></i>Relatório de Comissões</a></li>

									<li class=""><a href="#" data-toggle="modal" data-target="#RelCon"><i class="fa fa-angle-right"></i>Relatório de Contas</a></li>


									<li class=""><a href="#" data-toggle="modal" data-target="#RelAniv"><i class="fa fa-angle-right"></i>Relatório de Aniversáriantes</a></li>


									<li class=""><a href="#" data-toggle="modal" data-target="#RelLucro"><i class="fa fa-angle-right"></i>Demonstrativo de Lucro</a></li>
							...
							<li class="treeview " >
								...
								<ul class="treeview-menu">
									...
									<li class=""><a href="index.php?pag=textos_index"><i class="fa fa-angle-right"></i>Textos Index</a></li>


									<li class=""><a href="index.php?pag=comentarios"><i class="fa fa-angle-right"></i>Comentários</a></li>
		...
		<!--footer-->
		<div class="footer">
      <p> Desenvolvido Por Fábio Sousa <a href="https://www.fabiosousa.dev.br/" target="_blank">www.fabiosousa.dev.br</a></p>
		</div>
		<!--//footer-->
	</div>
